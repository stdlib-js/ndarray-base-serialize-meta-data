...
```javascript
serialize = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-serialize-meta-data@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-serialize-meta-data@umd/bundle.js"></script>
```
